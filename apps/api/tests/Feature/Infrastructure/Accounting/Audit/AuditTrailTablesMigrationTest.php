...
final class AuditTrailTablesMigrationTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        // `posting_idempotency_keys` is not this class's own concern,
        // but another test class sharing this real database within the
        // same PHPUnit process may have left rows referencing a
        // `journals` row this class is about to delete below.
        DB::connection('pgsql')->table('posting_idempotency_keys')->delete();
