...
use App\Domain\Transactions\Income\Exception\InvalidIncomeIdException;
...
/**
 * Covers Income identity (M9) as a bare Value Object, mirroring
 * {@see JournalIdTest}'s own
 * coverage of the pattern this class deliberately reuses.
 */
final class IncomeIdTest extends TestCase
{
    public function test_valid_opaque_identifier_is_accepted(): void
    {
        $id = IncomeId::of('01J8Z3K7QYUXG5N7EXAMPLE01');

        $this->assertInstanceOf(IncomeId::class, $id);
    }

    public function test_exact_string_round_trip(): void
    {
        $id = IncomeId::of('income-0001');

        $this->assertSame('income-0001', $id->toString());
    }

    public function test_same_value_is_equal(): void
    {
        $a = IncomeId::of('income-0001');
        $b = IncomeId::of('income-0001');
    ...
    public function test_value_one_character_past_the_length_bound_is_rejected(): void
    {
        ...
        IncomeId::of(str_repeat('a', 65));
    }

    public function test_income_id_is_immutable(): void
    {
        $reflection = new ReflectionClass(IncomeId::class);
    ...
    {
        $incomeId = IncomeId::of('shared-value-0001');
        $journalId = JournalId::of('shared-value-0001');

        $this->assertNotInstanceOf(JournalId::class, $incomeId);
        $this->assertNotInstanceOf(IncomeId::class, $journalId);
    }
}
