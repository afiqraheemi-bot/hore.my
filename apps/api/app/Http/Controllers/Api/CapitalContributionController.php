 ...
 * {@see OwnerEquityMovementType::Contribution} — mirrors
 * {@see IncomeController} exactly, for the
 * identical reason, including deriving the identifiers deterministically
 * via {@see DeterministicIdempotentId} rather than freshly random. See
 * {@see OwnerDrawingController} for the
 * Drawing counterpart — the only difference between the two controllers
 * is this fixed movement type.
 */
