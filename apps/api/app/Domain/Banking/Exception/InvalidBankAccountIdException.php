...
/**
 * Thrown when a value is not a canonical BankAccount identifier (M17).
 *
 ...
 */
final class InvalidBankAccountIdException extends \InvalidArgumentException
{
    public static function forValue(string $value): self
    {
        return new self(sprintf('Value "%s" is not a canonical BankAccount identifier.', $value));
    }
}
