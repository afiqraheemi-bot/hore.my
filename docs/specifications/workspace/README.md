...
| --- | --- | --- | --- | --- |
| [WT-001 — Task & Proposal State Model Test Specification](tests/WT-001-Task-Proposal-State-Model-Test-Specification.md) | Active | 1.1.0 | [WTS-001](WTS-001-Task-Proposal-State-Model.md) | 57 test IDs (`TSK-T001`–`TSK-T057`) tracing `TSK-001`–`TSK-012` across unit, isolated real-PostgreSQL migration, service integration, HTTP, concurrency, fault-injection and real-browser E2E tests, with partially deferred coverage recorded explicitly for `TSK-006` and `TSK-008` |
