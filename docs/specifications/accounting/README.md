...
| [ATS-005 — Chart of Accounts Test Specification](tests/ATS-005-Chart-of-Accounts-Test-Specification.md) | Active | 1.3.0 | [AETS-005](AETS-005-Chart-of-Accounts.md) | 112 test IDs (`COA-T001`–`COA-T112`) tracing every `COA-NNN` invariant to at least one test; type/normal-balance and hierarchy property-based generators, golden account cases, tenant-isolation, posting-eligibility, Account deactivation-lifecycle, fail-closed incomplete-hierarchy-context, and Account reconstitution tests |
