...
| [ATS-005 — Chart of Accounts Test Specification](tests/ATS-005-Chart-of-Accounts-Test-Specification.md) | Active | 1.5.0 | [AETS-005](AETS-005-Chart-of-Accounts.md) | 147 test IDs (`COA-T001`–`COA-T147`) tracing every `COA-NNN` invariant to at least one test; type/normal-balance and hierarchy property-based generators, golden account cases, tenant-isolation, posting-eligibility, Account deactivation-lifecycle, fail-closed incomplete-hierarchy-context, Account reconstitution, Account Origin (System/User-Created) construction and structural System Account protection, and real-PostgreSQL Account persistence adapter tests |
